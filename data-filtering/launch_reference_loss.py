...
if __name__ == "__main__":
    ...
    parser.add_argument("--seed", type=int, nargs="+", required=True)  # Add more later
    ...
    for seed in args.seed:
        ...
        if args.cluster in ["r9z1", "r14z3", "r14z3p2", "r15z1", "r15z1p1"]:
        ...
        base_run.command = base_run.command.replace(r"{seed}", str(seed))
        ...
        # Set run name
        run_name = f"sd-{seed}-build-ref-loss"
